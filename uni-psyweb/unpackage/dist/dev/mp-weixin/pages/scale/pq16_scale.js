...
const _sfc_main = {
  __name: "pq16_scale",
  setup(__props) {
    const scalelist = utils_scale.getPq16Scale();
    const handleSubmit = (totalScore) => {
      common_vendor.index.navigateTo({
        url: "pq16_result?score=" + totalScore
      });
    };
    const goback = () => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-5a3cb4ab"]]);
