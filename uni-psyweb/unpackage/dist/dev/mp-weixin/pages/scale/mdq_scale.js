...
const _sfc_main = {
  __name: "mdq_scale",
  setup(__props) {
    const scalelist = utils_scale.getMdqScale();
    const handleSubmit = (totalScore) => {
      common_vendor.index.navigateTo({
        url: "mdq_result?score=" + totalScore
      });
    };
    const goback = () => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-996eda61"]]);
