...
const _sfc_main = {
  __name: "sds_scale",
  setup(__props) {
    const scalelist = utils_scale.getSdsScale();
    const handleSubmit = (totalScore) => {
      common_vendor.index.navigateTo({
        url: "sds_result?score=" + totalScore
      });
    };
    const goback = () => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-e7bdbe1f"]]);
